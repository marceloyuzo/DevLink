...
export function Admin() {
   ...
   const [backgroundColorInput, setBackgroundColorInput] = useState("black")
   ...
   return(
      <div className="flex items-center flex-col min-h-screen pb-7 px-2">
         ...
         {links.map((link) => (
         <article key={link.id}
            className="flex w-full max-w-xl justify-between items-center rounded py-3 px-2 mb-2 select-none"
